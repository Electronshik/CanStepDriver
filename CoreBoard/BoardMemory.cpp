...
void Memory_I2C::Write(size_t MemAddress, uint8_t* Data, uint32_t Size)
{
	...
	while (i < Size)
	{
		...
		// if ( HAL_OK != HAL_I2C_Mem_Write(&hi2c2, I2C_EEPROM_ADDRESS << 1, MemAddress, I2C_MEMADD_SIZE_16BIT, Data, j,
		// I2C_EEPROM_TIMEOUT) )
		// {
		// 	return -1;
		// }
...
void Memory_I2C::Read(size_t MemAddress, uint8_t* Data, uint32_t Size)
{
	...
	while (i < Size)
	{
		...
		// if ( HAL_OK != HAL_I2C_Mem_Read (&hi2c2, I2C_EEPROM_ADDRESS << 1, MemAddress, I2C_MEMADD_SIZE_16BIT, Data, j,
		// I2C_EEPROM_TIMEOUT))
		// {
		// 	return -1;
		// }
